...
export async function generateMetadata() {
  ...
  const instanceName = settings?.instanceName || "AtomicRouter";
  ...
  return {
    ...
    description:
      "AtomicRouter is an ultra-lightweight universal AI gateway for multi-provider LLMs. One endpoint for all your AI providers.",
